...
def get_args():
    ...
    parser.add_argument('--load_model_epoch', '-lme', type=str, default="U_epoch_final", help='load model epoch') # U_epoch_final
...
if __name__ == '__main__':
    ...
    print(f"Loading model from saved_models/{args.model}/{args.load_model_epoch}.pth")
    model.load_state_dict(torch.load(f"saved_models/{args.model}/{args.load_model_epoch}.pth"))
