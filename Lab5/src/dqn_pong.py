...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-dir", type=str, default="./results/dqn_pong")
    parser.add_argument("--wandb-run-name", type=str, default="dqn_pong-run")
    ...
    wandb.init(project="DLP-Lab5-DQN_ATARI-Pong", name=args.wandb_run_name, save_code=True)
