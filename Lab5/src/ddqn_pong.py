...
class DQNAgent:
    def __init__(self, env_name="ALE/Pong-v5", args=None, n_steps=3):
        ...
        for ep in range(episodes):
            ...
            while not done and step_count < self.max_episode_steps:
                ...
                if self.env_count % 200000 == 0:
                    model_path = os.path.join(self.save_dir, f"LAB5_112AB8005_task3_pong{self.env_count}.pt")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-dir", type=str, default="./results/ddqn")
    parser.add_argument("--wandb-run-name", type=str, default="ddqn_pong-run")
    ...
    wandb.init(project="DLP-Lab5-DDQN-Pong", name=args.wandb_run_name, save_code=True)
